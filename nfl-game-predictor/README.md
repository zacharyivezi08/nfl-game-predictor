...
1. **Data**: every NFL game since 1999 (scores, dates, rest days, location) from nflverse.
...
3. **Models**: logistic regression, random forest and gradient boosting are trained on 2002–2021 and tested on 2022–2025 (games the model never saw).
4. **Explanations**: the logistic regression weights show which factors pushed each prediction toward one team.
